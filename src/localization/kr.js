const kr = {
  ...
  homeService: {
    ...
    card2: {
      ...
      details: "تطبيقات Bulid Mobile للتكيف مع العالم المتمركز حول الجوال",
      buttonText: "زيارة الآن",
    },
    card3: {
      title: "تطوير البرمجيات",
      details: "قم ببناء برنامج لتكييف العالم المتمركز حول الأجهزة المحمولة",
      buttonText: "زيارة الآن",
    },
    card4: {
      title: "خدمات التطوير",
    ...
    card5: {
      title: "بلوكشين",
      details:
        "تقدم خدمة blockchain الخاصة بنا معاملات آمنة وشفافة ولامركزية تمكن الثقة والكفاءة في مختلف الصناعات في جميع أنحاء العالم.",
      buttonText: "زيارة الآن",
    },
    card6: {
      title: "خدمات اختبار البرمجيات",
      details: "نحن نقدم أتمتة الاختبار واختبار التحميل",
      buttonText: "زيارة الآن",
    },
  },
  homeIdea: {
  ...
  homeProduct: {
    ...
    card1: {
      ...
      details:
        "ابق في طليعة تطور المدفوعات الرقمية مع خدمات تطوير محفظة NewrozTech الإلكترونية. نحن نقدم خدمات تطوير تطبيقات المحفظة الإلكترونية الغنية بالميزات والمضمونة بالكامل لأجهزة Android و iPhone وكذلك لمتصفح الويب. استفد من خبرتنا واحصل على تطبيق المحفظة الإلكترونية المحمي بالكامل وسهل الاستخدام مع تصميمات UI / UX المتميزة.",
    },
    card2: {
      title: "محفظة FastPay الإلكترونية",
      details:
