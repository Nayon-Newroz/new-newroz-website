            ...
            <Grid container alignItems="center" spacing={{ xs:2, sm: 2, md: 0 }}>
              <Grid item xs={12} sm={6} md={3}>
                ...
                >
                  ...
                  >
                    {translations.servicesDetails.cardSection2.card1.title}
                  </h4>
                </div>
              </Grid>
              ...
              <Grid item xs={12} sm={6} md={3}>
                ...
                >
                  ...
                  >
                    {translations.servicesDetails.cardSection2.card2.title}
                  </h4>
                </div>
              </Grid>
              <Grid item md={1.5} className="hideForTabViewOnly">
              ...
              <Grid item xs={12} sm={6} md={3}>
                ...
                >
                  ...
                  >
                    {translations.servicesDetails.cardSection2.card3.title}
                  </h4>
                </div>
              </Grid>
              ...
              <Grid item xs={12} sm={6} md={3}>
                ...
                >
                  ...
                  >
                    {translations.servicesDetails.cardSection2.card4.title}
                  </h4>
                </div>
              </Grid>
              <Grid item md={1.5} className="hideForTabViewOnly">
              ...
              <Grid item xs={12} sm={6} md={3}>
                ...
                >
                  ...
                  >
                    {translations.servicesDetails.cardSection2.card5.title}
                  </h4>
                </div>
              </Grid>
              <Grid item md={1.5} className="hideForTabViewOnly">
