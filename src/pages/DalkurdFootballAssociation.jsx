...
const DalkurdFootballAssociation = ({ translations, lang, darkMode }) => {
  const firstImage = "/images/Dalkurd_HomePage.png";
      ...
      <Container maxWidth="xl">
            ...
            <Grid container alignItems="center">
              ...
              >
                <h2 className={`title_large2 ${darkMode && "lightBlue"}`}>
                  {translations.homeProduct.card2.info.title}
                </h2>
                <p className="text_body_small_regular fw400 mb24">
                  {translations.homeProduct.card2.info.subtitle}
                </p>

                <p className={`text_body_medium  mb6 ${darkMode && "white"}`}>
                  {translations.homeProduct.card2.info.details}
                </p>
              </Grid>
              <Grid item sm={12} md={6} lg={6} className="left_order_maintain">
                <img
                  src="/images/Dalkurd2.png"
                  alt="our company"
        ...
        <div className="section_style">
          ...
          <div className="upper_slide">
            ...
            >
              {translations.homeProduct.card2.info.featuresTitle}
            </h4>
            <div className="card_holder">
              {translations.homeProduct.card2.info?.features?.map((item, i) => (
                <div
                  key={i}
        ...
        <div className="section_style">
          ...
          <div className="upper_slide">
            ...
            >
              ...
              >
                {translations.homeProduct.card2.info.problemStatementsTitle}
              </h4>
              <ol className={`ol_Style fw400 ${darkMode && "ol_Style_dark"}`}>
                {translations.homeProduct.card2.info?.problemStatements?.map(
                  (item, i) => (
                    <li key={i}>
                      <b>{item.textBold}&nbsp;</b>
                      {item.text}
            ...
            >
              ...
              >
                {translations.homeProduct.card2.info.solutionsTitle}
              </p>
              <ol className={`ol_Style fw400 ${darkMode && "ol_Style_dark"}`}>
                {translations.homeProduct.card2.info?.solutions?.map(
                  (item, i) => (
                    <li key={i}>
                      <b>{item.textBold}&nbsp;</b>
                      {item.text}
        ...
        <div className="section_style">
          ...
          <div className="upper_slide">
            ...
            >
              {translations.homeProduct.card2.info.productScreensTitle}
            </h4>
            <Grid container alignItems="center" spacing={3}>
              <Grid
                ...
                className="mobile_view_center right_order_maintain"
              >
                {translations.homeProduct.card2.info?.productScreens?.map(
                  (item, i) => (
                    <Accordion
                      key={i}
          ...
          <div className="upper_slide">
            ...
            <Grid container alignItems="center" spacing={3}>
              ...
              >
                ...
                >
                  {translations.homeProduct.card2.info.technologiesUsedTitle}
                </h4>
                ...
                <Grid
                  ...
                  style={{ gap: "14px" }}
                >
                  {translations.homeProduct.card2.info?.technologies?.map(
                    (item, i) => (
                      <div
                        key={i}
              ...
              >
                ...
                >
                  {translations.homeProduct.card2.info.availableOnTitle}
                </h4>
...
export default DalkurdFootballAssociation;
