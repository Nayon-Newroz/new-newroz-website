...
const FastConnectPOS = ({ translations, lang, darkMode }) => {
  const firstImage = "/images/FastConnect_HomePage.png";
      ...
      <Container maxWidth="xl">
            ...
            <Grid container alignItems="center">
              ...
              >
                <h2 className={`title_large2 ${darkMode && "lightBlue"}`}>
                  {translations.homeProduct.card3.info.title}
                </h2>
                <p className="text_body_small_regular fw400 mb24">
                  {translations.homeProduct.card3.info.subtitle}
                </p>

                <p className={`text_body_medium  mb6 ${darkMode && "white"}`}>
                  {translations.homeProduct.card3.info.details}
                </p>
              </Grid>
        ...
        <div className="section_style">
          ...
          <div className="upper_slide">
            ...
            >
              {translations.homeProduct.card3.info.featuresTitle}
            </h4>
            <div className="card_holder">
              {translations.homeProduct.card3.info?.features?.map((item, i) => (
                <div
                  key={i}
        ...
        <div className="section_style">
          ...
          <div className="upper_slide">
            ...
            >
              ...
              >
                {translations.homeProduct.card3.info.problemStatementsTitle}
              </h4>
              <ol className={`ol_Style fw400 ${darkMode && "ol_Style_dark"}`}>
                {translations.homeProduct.card3.info?.problemStatements?.map(
                  (item, i) => (
                    <li key={i}>
                      <b>{item.textBold}&nbsp;</b>
                      {item.text}
            ...
            >
              ...
              >
                {translations.homeProduct.card3.info.solutionsTitle}
              </p>
              <ol className={`ol_Style fw400 ${darkMode && "ol_Style_dark"}`}>
                {translations.homeProduct.card3.info?.solutions?.map(
                  (item, i) => (
                    <li key={i}>
                      <b>{item.textBold}&nbsp;</b>
                      {item.text}
        ...
        <div className="section_style">
          ...
          <div className="upper_slide">
            ...
            >
              {translations.homeProduct.card3.info.productScreensTitle}
            </h4>
            <Grid container alignItems="center" spacing={3}>
              <Grid
                ...
                className="mobile_view_center right_order_maintain"
              >
                {translations.homeProduct.card3.info?.productScreens?.map(
                  (item, i) => (
                    <Accordion
                      key={i}
          ...
          <div className="upper_slide">
            ...
            <Grid container alignItems="center" spacing={3}>
              ...
              >
                ...
                >
                  {translations.homeProduct.card3.info.technologiesUsedTitle}
                </h4>
                ...
                <Grid
                  ...
                  style={{ gap: "14px" }}
                >
                  {translations.homeProduct.card3.info?.technologies?.map(
                    (item, i) => (
                      <div
                        key={i}
              ...
              >
                ...
                >
                  {translations.homeProduct.card3.info.availableOnTitle}
                </h4>
