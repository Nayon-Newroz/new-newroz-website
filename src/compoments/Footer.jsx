        ...
        <Container maxWidth="xl" style={{ padding: "100px 0 53px 0" }}>
          <Grid container spacing={4}>
            ...
            <Grid item xs={12} sm={6} md={6} lg={2}>
              ...
              <p className="footer_item">{translations.footer.blog}</p>
              <p className="footer_item">{translations.footer.careers}</p>
              <p className="footer_item">{translations.footer.jobs}</p>
              <p className="footer_item">{translations.footer.Portfolio}</p>
            </Grid>
            <Grid item xs={12} sm={6} md={6} lg={3}>
              ...
              <p className="footer_item">
                {translations.footer.webAppDevelopment}
              </p>
              <p className="footer_item">
                {translations.footer.mobileAppDevelopment}
              </p>
              <p className="footer_item">
                {translations.footer.cloudConsultancy}
              </p>
              <p className="footer_item">
                {translations.footer.customSoftwareDevelopment}
              </p>
              <p className="footer_item">{translations.footer.inPress}</p>
            </Grid>
            <Grid item xs={12} sm={6} md={6} lg={3}>
              <p className="footer_title">
              ...
              <p className="footer_item">
                {translations.footer.technicalDebtReduction}
              </p>
              <p className="footer_item">
                {translations.footer.roboticProcessAutomation}
              </p>

              <p className="footer_item">
                {translations.footer.aIAndMachineLearning}
              </p>
              <p className="footer_item">{translations.footer.chatbots}</p>
            </Grid>
          </Grid>
        </Container>
      </div>
